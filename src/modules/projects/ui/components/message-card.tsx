...
const FragmentCard = ({
    ...
    return (
        <button className={cn(
            "flec items-start text-start gap-2 border rounded-lg bg-muted w-fit p-3 hover:bg-secondary transition-colors",
...
const UserMessage = ({content}: UserMessageProps) => {
    return (
        <div className="flex justify-end pb-4 pr-2 pl-10 ">
            <Card className="rounded-large bg-muted p-3 shadow-none border-none max-w-[80%] wrap-break-word ">
                {content}
            </Card>
        </div>
    )
